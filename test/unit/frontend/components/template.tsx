...
import { TemplateTest } from '@tdd/frontend'
import 'chai/register-should'
import { suite, test } from 'mocha-typescript'
import * as React from 'react'

class Button extends Template<{ label: string; handler: () => string }> {
  render() {
    return (
...
@suite('Unit::Frontend::Components::Template')
export class Test extends TemplateTest<Button> {
  template = Button
